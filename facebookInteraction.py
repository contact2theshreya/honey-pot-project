...
'''        
mutual=browser.find_elements_by_xpath("//div[@class='_6a _6b']")
#mutual=browser.find_elements_by_xpath("//a[@class='_39g5']")
...
for l1 in mutual:
  ...
  l2= l1.find_element_by_xpath("//a[@class='_39g5']")
  print l2.find_element_by_tag_name("a").text
'''
